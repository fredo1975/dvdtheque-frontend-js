...
export const AMAZON_PRIME = 'AMAZON_PRIME'
export const DISNEY_PLUS = 'DISNEY_PLUS'
...
export const allocinePaginatedSearch = '/paginatedSarch'
export const exportUrl = '/films/export'
export const importUrl = '/invokejob/films/import'
export const defaultQuery = 'origine:eq:DVD:AND,'
export const allocineDefaultQuery = ''
export const defaultSort = '-dateInsertion,+titre'
export const allocineDefaultSort = '-creationDate'